...
void main() {
   ...
   spherePos.x += (loop) * spherePos.x * (1. - (sin(uTime * .0015 + (aParams.x * 10.)) - 1.));
   spherePos.y += (loop) * spherePos.y * (2. - (sin(uTime * .0015 + (aParams.x * 5.))));
   spherePos.z += (loop) * spherePos.z * (1. - (cos(uTime * .0015 + (aParams.x * 2.)) - 1.));
