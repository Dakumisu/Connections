...
class Preloader {
   ...
   preload() {
      gsap.to(Store.nodes.preload_value, 5,{ scaleX: 1, ease: "Power3.easeInOut", onComplete: () => {
         gsap.to(Store.nodes.preloader, 1, { opacity: 0, ease: "Power0.easeNone", onComplete: () => {
            ...
            gsap.fromTo(Store.nodes.start, 2, { opacity: 0, yPercent: -20 }, {yPercent: 0, opacity: .85, ease: "Power3.easeInOut", delay: 1 })
            gsap.fromTo(Store.nodes.mobile_view, 2, { opacity: 0, yPercent: -20 }, {yPercent: 0, opacity: .75, ease: "Power3.easeInOut", delay: 1.15 })
            gsap.fromTo(Store.nodes.localisation, 2, { opacity: 0, yPercent: -20 }, {yPercent: 0, opacity: .85, ease: "Power3.easeInOut", delay: 1.25 })
